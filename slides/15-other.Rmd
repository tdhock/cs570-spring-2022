...
```{python}
from_zero_to_one = np.linspace(0,1)
zero_one_grid = make_grid(pd.DataFrame({
    "pred_prob1":from_zero_to_one,
    "pred_prob2":from_zero_to_one
}))
zero_one_grid["pred_prob0"] = 1-zero_one_grid.pred_prob1-zero_one_grid.pred_prob2
zero_one_grid.query("pred_prob0 >= 0 & pred_prob0+pred_prob1+pred_prob2<=1")
